...
class MyBackgroundService : Service() {
    ...
    companion object {
        ...
        private val PACKAGE_NAME = "com.rafaelm.mapsandroidq"
    ...
    override fun onCreate() {
        ...
        val handlerThread = HandlerThread("Rafael")
        handlerThread.start()
    ...
    fun removeLocationUpdates() {
        try{
            ...
            Log.e("Rafael", "Lost location permission. Could not remove update. $ex")
        }
    }
            ...
            fusedLocationProviderClient!!.lastLocation
                .addOnCompleteListener { task ->
                    if (task.isSuccessful && task.result != null)
                        ...
                        Log.e("LOCATION", "FALHOU A LOCATION")
                }
        } catch (ex: SecurityException) {
            Log.e("LOCATION", "" + ex.message)
        }
    }
    ...
    override fun onUnbind(intent: Intent?): Boolean {
        if(mChangingConfiguration && Common.requestLocationUpdate(this))
    ...
    fun requestLocationUpdates(){
        ...
        try{
            ...
            Common.setRequestingLocationUpdate(this,false)
            Log.e("Rafael", "Lost location permission $ex")
        }
    }
}
